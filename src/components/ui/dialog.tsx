  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          'fixed top-[50%] left-[50%] z-50 grid max-h-[calc(100dvh-2rem)] w-full max-w-[calc(100%-2rem)] overflow-y-auto translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border bg-background p-6 shadow-lg outline-none transition-[opacity,scale] duration-200 ease-out data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-ending-style:scale-95 data-ending-style:opacity-0 sm:max-w-lg',
          className,
        )}
        {...props}
      >
